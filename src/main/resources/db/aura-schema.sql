...
CREATE TABLE IF NOT EXISTS cleanup_jobs (
	...
	user_id BIGINT UNSIGNED NOT NULL,
	scan_job_id BIGINT UNSIGNED NULL,
	action_type ENUM('MOVE_TO_TRASH', 'RESTORE_FROM_TRASH', 'PERMANENT_DELETE', 'EMPTY_TRASH') NOT NULL,
...
CREATE TABLE IF NOT EXISTS cleanup_histories (
	...
	cleanup_job_id BIGINT UNSIGNED NOT NULL,
	scan_job_id BIGINT UNSIGNED NULL,
	action_type ENUM('MOVE_TO_TRASH', 'RESTORE_FROM_TRASH', 'PERMANENT_DELETE', 'EMPTY_TRASH') NOT NULL DEFAULT 'MOVE_TO_TRASH',
...
ALTER TABLE cleanup_jobs
	MODIFY COLUMN action_type ENUM('MOVE_TO_TRASH', 'RESTORE_FROM_TRASH', 'PERMANENT_DELETE', 'EMPTY_TRASH') NOT NULL;

ALTER TABLE cleanup_histories
	MODIFY COLUMN action_type ENUM('MOVE_TO_TRASH', 'RESTORE_FROM_TRASH', 'PERMANENT_DELETE', 'EMPTY_TRASH') NOT NULL DEFAULT 'MOVE_TO_TRASH';
