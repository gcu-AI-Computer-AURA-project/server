...
CREATE TABLE IF NOT EXISTS scan_jobs (
	...
	CONSTRAINT fk_scan_jobs_scan_setting FOREIGN KEY (setting_id) REFERENCES scan_settings (setting_id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS scanned_items (
	...
	created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
	PRIMARY KEY (item_id),
	UNIQUE KEY uk_scanned_items_scan_source_external (scan_job_id, item_source, external_item_id),
...
CREATE TABLE IF NOT EXISTS analysis_candidates (
	...
	selection_version INT UNSIGNED NOT NULL DEFAULT 1,
	estimated_reclaim_bytes BIGINT UNSIGNED NOT NULL DEFAULT 0,
