...
CREATE TABLE IF NOT EXISTS cleanup_jobs (
	...
	user_id BIGINT UNSIGNED NOT NULL,
	scan_job_id BIGINT UNSIGNED NULL,
	action_type ENUM('MOVE_TO_TRASH', 'PERMANENT_DELETE', 'EMPTY_TRASH', 'RESTORE_FROM_TRASH') NOT NULL,
...
CREATE TABLE IF NOT EXISTS cleanup_histories (
	...
	cleanup_job_id BIGINT UNSIGNED NOT NULL,
	scan_job_id BIGINT UNSIGNED NULL,
	action_type ENUM('MOVE_TO_TRASH', 'PERMANENT_DELETE', 'EMPTY_TRASH', 'RESTORE_FROM_TRASH') NOT NULL DEFAULT 'MOVE_TO_TRASH',
